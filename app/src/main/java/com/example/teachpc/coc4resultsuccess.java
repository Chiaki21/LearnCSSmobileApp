...
public class coc4resultsuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coc4resultsuccess);

        getWindow().setStatusBarColor(ContextCompat.getColor(coc4resultsuccess.this,R.color.colorPrimaryDark));
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(coc4resultsuccess.this,Quizzes.class));
                finish();
