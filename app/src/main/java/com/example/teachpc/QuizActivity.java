...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(QuizActivity.this,R.color.colorPrimaryDark));
        ...
        long duration = TimeUnit.MINUTES.toMillis(1); // TIME IN MINUTE
        ...
        new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                    ...
                    Intent intent = new Intent(QuizActivity.this, QuizTimesUp.class);
                ...
                builder.setTitle("Alert!!")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                startActivity(new Intent(QuizActivity.this,Quizzes.class));
                                finish();
    ...
    private void changeNextQuestion(){
        ...
        if (currentQuestionPosition < questionsLists.size()) {
            ...
            if (getCorrectAnswers() >= 12) {
                ...
                Intent intent = new Intent(QuizActivity.this, QuizFailed.class);
                intent.putExtra("correct", getCorrectAnswers());
                intent.putExtra("incorrect", getIncorrectAnswers());
                startActivity(intent);
                finish();
