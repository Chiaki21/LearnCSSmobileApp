...
public class coc2resultsuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coc2resultsuccess);

        getWindow().setStatusBarColor(ContextCompat.getColor(coc2resultsuccess.this,R.color.colorPrimaryDark));
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(coc2resultsuccess.this,Quizzes.class));
                finish();
