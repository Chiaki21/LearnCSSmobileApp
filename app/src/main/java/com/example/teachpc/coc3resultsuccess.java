...
public class coc3resultsuccess extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coc3resultsuccess);

        getWindow().setStatusBarColor(ContextCompat.getColor(coc3resultsuccess.this,R.color.colorPrimaryDark));
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(coc3resultsuccess.this,Quizzes.class));
                finish();
